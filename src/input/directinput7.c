...
void InputInit(void)
{
    ...
    DirectInputCreateEx(GetModuleHandle(NULL), DIRECTINPUT_VERSION, IID_IDirectInput7, (void **)&pDI, NULL);
    pDI->CreateDeviceEx(GUID_SysKeyboard, IID_IDirectInputDevice7, (void **)&pKeyboard, NULL);

//    LogWrite("Initializing Keyboard State", 1, MT_INFO, NULL);
//    Input.currentKeystate = SDL_GetKeyboardState(NULL);
