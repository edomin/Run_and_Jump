...
#define RNJ_SPRITE_NUM_FILLED_RECT -4 /* Номер спрайта для закрашеного прямоугольника */
...
#define ZAXIS_COORD 0 /* координата по оси z для всех объектов */
#define ZAXIS_LENGTH 32 /* длина по оси z для всех объектов */
...
#define PHYS_JOINT_MAX_SIZE 0 /* Максимальный размер соединения. Всегда должно быть равно нулю */
#define PHYS_MAX_CONTACTS 16 /* Максимальное количество контактов соприкосновения двух тел */
#define PHYS_COLLIDE_DATA 0 /* Указатель на какую-то фигню. Всегда 0 */

/* Другое */
#define BASE_DECIMAL 10 /* Основание десятичной системы */
#define ASCII_ZERO_CODE 0x30 /* Код символа "0" */
#define X32_MAX_INT_DIGITS 10/* Максимальное число знаков и типе int на 32-разрядной платформе */
