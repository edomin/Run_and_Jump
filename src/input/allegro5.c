...
void InputInit(void)
{
    ...
    if (Input.controllersCount > 0)
    {
        ...
        al_register_event_source(Input.controllerEQ,
        ...
        for (i = 0; i < Input.controllersCount; i++)
        {
            ...
            LogWrite("Controller name:", 3, MT_INFO,
                     (char *)al_get_joystick_name(Input.controller[i]));
